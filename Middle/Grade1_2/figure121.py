...
def figure121_Stem_013():
    ...
    if flag == 2:
      ...
      ##rrr ="$$수식$$ \overrightarrow{AB} ,\overrightarrow{AC} ,\overrightarrow{AD} , \overrightarrow{AE} , \overrightarrow{BA},\overrightarrow{BC},\overrightarrow{BD}, $$수식$$ \n "\
      ##     "$$수식$$   \overrightarrow{BE}, \overrightarrow{CA},  \overrightarrow{CB},  \overrightarrow{CD}, \overrightarrow{CE}, \overrightarrow{DA},   \overrightarrow{DB}, $$수식$$ \n "\
      ##"$$수식$$   \overrightarrow{DC}, \overrightarrow{DE}, \overrightarrow{EA},  \overrightarrow{EB}, \overrightarrow{EC},  \overrightarrow{ED}  $$수식$$ "\
      ##rrr = "{abr}, {acr}, {adr}, {aer}, {bar}, {bcr}, {bdr}, {ber}, {car}, {cbr}".format(abr=abr, acr=acr, adr=adr, aer=aer, bar=bar, bcr=bcr, bdr=bdr, ber=ber, car=car, cbr=cbr ) + " \n " +  "{cdr}, {cer}, {dar}, {dbr}, {dcr}, {der}, {ear}, {ebr}, {ecr}, {edr}".format(cdr=cdr, cer=cer, dar=dar, dbr=dbr, dcr=dcr, der=der, ear=ear, ebr=ebr, ecr=ecr, edr=edr)
